""" To view this example, first start a Bokeh server:
	...
	bokeh serve --address 0.0.0.0 --allow-websocket-origin=You_server_IP:8000
...
from bokeh.embed import server_session #that works with bokeh version 0.12.15
#from bokeh.embed import autoload_server #original code
...
""" % server_session(p, session_id=session.id) #autoload_server(p, session_id=session.id)
